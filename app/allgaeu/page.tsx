...
const pageMetadata = createPageMetadata({
  title: "Triathlon Coaching Allgäu Triathlon | Andreas Schoenherr",
  description:
    "Persönliches Triathlon Coaching von Andreas Schoenherr. Train Smart. Not Hard. Kostenloses Kennenlerngespräch für Allgäu Triathlon Teilnehmer und alle ambitionierten Ausdauersportler.",
  path: "/allgaeu",
});
...
export default function AllgaeuPage() {
  return (
    <BookingProvider>
      <JsonLd
        data={createBreadcrumbStructuredData([
          breadcrumbHome,
          { name: "Allgäu Triathlon", path: "/allgaeu" },
        ])}
      />
      <SiteHeader />
            ...
            <div className="flex flex-col justify-center lg:w-[55%] lg:shrink-0">
              <div className="max-w-3xl">
                <h1 className="text-4xl font-semibold leading-tight tracking-tight md:text-5xl">
                  Schön, dass wir uns beim Allgäu Triathlon kennengelernt haben.
                </h1>
                <p className="mt-8 text-lg leading-relaxed text-muted md:text-xl">
                  Vielleicht haben wir uns auf der Expo, auf dem Campingplatz, an
                  der Strecke, im Zielbereich oder einfach bei einem Kaffee
                  getroffen.
                </p>
          ...
          <div className="mx-auto max-w-7xl px-6 py-28 md:px-12 md:py-40">
            <div className="max-w-3xl">
              ...
              <div className="mt-8 space-y-5 text-base leading-relaxed text-muted md:text-lg">
                ...
                <p>
                  Auch wenn wir uns beim Allgäu Triathlon nicht persönlich
                  getroffen haben, bist Du selbstverständlich herzlich zu einem
                  kostenlosen Kennenlerngespräch eingeladen.
                </p>
              </div>
              <div className="mt-8">
                <BookingButton url={INTRO_CALL_URL}>
